...
OffroadHome::OffroadHome(QWidget* parent) : QFrame(parent) {
  ...
  offroadSplashImageLabel->setGeometry(0, 0, 1050, 600);
  offroadSplashImageLabel->setAlignment(Qt::AlignHCenter | Qt::AlignVCenter);
  offroadSplashImageLabel->setPixmap(QPixmap("../assets/images/offroad_splash.png").scaled(offroadSplashImageLabel->size(), Qt::KeepAspectRatio, Qt::SmoothTransformation));
